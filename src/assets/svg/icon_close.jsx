...
const IconClose = memo((props) => {
	return (
		<svg viewBox="0 0 24 24" role="img" aria-hidden="false" aria-label="关闭" focusable="false"
				 style={styleStrToObject("height: 2em; width: 2em; display: block; fill: rgb(255, 255, 255);")}>
			<path
