...
const IconArrowLeft = memo((props) => {
	...
	return (
		<svg viewBox="0 0 18 18" role="img" aria-hidden="false" aria-label="previous" focusable="false"
				 style={styleStrToObject(`height: ${height}px; width: ${width}px; display: block; fill: currentcolor;`)}>
